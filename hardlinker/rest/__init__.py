...
class HardlinkerJSONEncoder(json.JSONEncoder):
    """
    ...
    def default(self, o):
        ...
        if isinstance(o, Enum):
            return str(o)
        return super(HardlinkerJSONEncoder, self).default(o)


class HardlinkerRequest(falcon.Request):
    """
...
class HardlinkerResponse(falcon.Response):
    """
...
class JSONTranslator(object):
    ...
    def process_response(self, req, resp, resource):
        ...
        resp.body = json.dumps(resp.json, cls=HardlinkerJSONEncoder, ensure_ascii=False)
...
def create_api(disable_auth=False):
    ...
    return falcon.API(request_type=HardlinkerRequest, response_type=HardlinkerResponse, middleware=middleware)
